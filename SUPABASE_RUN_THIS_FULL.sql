-- Super-Cube® LMS — FULL schema (clean, safe to re-run)
-- Paste ALL into Supabase SQL Editor and click Run
...
-- Learner progress snapshot (mirrors LocalLmsState JSON for multi-device sync)
-- Safe to re-run: IF NOT EXISTS


-- ========== 002 learner_state (cloud sync) ==========
