  ...
  return (
    <section className="border-b border-line bg-surface">
      <div className="container-site py-10 sm:py-12">
        ...
        <div className="mt-8 grid gap-3 rounded-2xl border border-line bg-elevated p-4 sm:grid-cols-3 sm:gap-0 sm:divide-x sm:divide-line sm:p-5">
          <div className="text-center sm:px-4">
            <p className="text-lg font-semibold tracking-tight text-ink">
              52 → 68
            </p>
            <p className="mt-0.5 text-xs text-muted">
              Mean capacity (illustrative 8-week pattern)
            </p>
          </div>
          <div className="text-center sm:px-4">
            <p className="text-lg font-semibold tracking-tight text-ink">
            ...
            <p className="mt-0.5 text-xs text-muted">
              Doctoral model · peer-reviewed paper
            </p>
          </div>
          <div className="text-center sm:px-4">
            <p className="text-lg font-semibold tracking-tight text-ink">
