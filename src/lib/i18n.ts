...
const dict = {
  en: {
    ...
    privacy: "Privacy",
    terms: "Terms",
    midCheck: "Mid-pathway check-in",
    doneToday: "Done for today",
    peerPulse: "Peer / manager pulse",
    choices: "Choices",
  ...
  zu: {
    ...
    privacy: "Ubumfihlo",
    terms: "Imigomo",
    midCheck: "Ukuhlola maphakathi nendlela",
    doneToday: "Kuqediwe namuhla",
    peerPulse: "Ukuhlola kontanga / umphathi",
    choices: "Izinketho",
    principles: "Izimiso",
    mental: "Ingqondo",
    emotional: "Imizwa",
