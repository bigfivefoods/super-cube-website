...
const en = {
  ...
  "footer.formName": "Name",
  "footer.formEmail": "Email",
  "footer.formMessage": "Message",
  "footer.formOrg": "Organisation (optional)",
  "footer.formSend": "Send message",
  "footer.formSending": "Sending…",
  "footer.formThanks": "Thank you",
  "footer.formReceived": "We’ve received your message.",
  "footer.formAnother": "Send another",
  "footer.formPrivacy":
...
const af: Record<I18nKey, string> = {
  ...
  "footer.formName": "Naam",
  "footer.formEmail": "E-pos",
  "footer.formMessage": "Boodskap",
  "footer.formOrg": "Organisasie (opsioneel)",
  "footer.formSend": "Stuur boodskap",
  "footer.formSending": "Stuur…",
  "footer.formThanks": "Dankie",
  "footer.formReceived": "Ons het jou boodskap ontvang.",
  "footer.formAnother": "Stuur nog een",
  "footer.formPrivacy":
    "Deur in te dien, stem jy in dat ons jou mag kontak oor Super-Cube®-programme.",
