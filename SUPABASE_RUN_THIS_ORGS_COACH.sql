-- =============================================================================
-- Super-Cube® — ORGS / COACH / CERTIFICATES
-- Paste into Supabase → SQL Editor → Run
-- Requires profiles (from FULL or 002). Safe to re-run.
-- =============================================================================

\i is not available in dashboard — content inlined below from 003_orgs_coach.sql
